...
export function PromptGenerator() {
  const [formData, setFormData] = useState({
    ...
    imageUrl: "",
    aspectRatio: "1:1",
    medium: "Cinematic Portrait",
    view: "Shallow depth of field",
    camera: "Canon EOS R5",
    lens: "None",
    film: "None",
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-normal text-gray-600">Midjourney Prompt Generator v0.4</CardTitle>
        <CardDescription>A handy tool for generating advanced prompts in Midjourney</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label>Film</Label>
              <Select value={formData.film} onValueChange={(value) => handleInputChange("film", value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="None">None</SelectItem>
                  <SelectItem value="Kodak Portra 400">Kodak Portra 400</SelectItem>
                  <SelectItem value="Fujifilm Pro 400H">Fujifilm Pro 400H</SelectItem>
                  <SelectItem value="Kodak Tri-X">Kodak Tri-X</SelectItem>
                  <SelectItem value="Ilford HP5">Ilford HP5</SelectItem>
                  <SelectItem value="Kodak Ektar 100">Kodak Ektar 100</SelectItem>
                  <SelectItem value="Fujifilm Velvia 50">Fujifilm Velvia 50</SelectItem>
                  <SelectItem value="Kodak Gold 200">Kodak Gold 200</SelectItem>
                  <SelectItem value="Ilford Delta 3200">Ilford Delta 3200</SelectItem>
                  <SelectItem value="Kodak T-Max 400">Kodak T-Max 400</SelectItem>
                  <SelectItem value="Fujifilm Provia 100F">Fujifilm Provia 100F</SelectItem>
                  <SelectItem value="Kodak Ektachrome E100">Kodak Ektachrome E100</SelectItem>
                  <SelectItem value="Ilford FP4 Plus">Ilford FP4 Plus</SelectItem>
                  <SelectItem value="Kodak Vision3 500T">Kodak Vision3 500T</SelectItem>
                  <SelectItem value="Fujifilm Neopan 100">Fujifilm Neopan 100</SelectItem>
                  <SelectItem value="Kodak ColorPlus 200">Kodak ColorPlus 200</SelectItem>
                  <SelectItem value="Ilford Pan F Plus">Ilford Pan F Plus</SelectItem>
                  <SelectItem value="Kodak Portra 160">Kodak Portra 160</SelectItem>
                  <SelectItem value="Fujifilm Superia 400">Fujifilm Superia 400</SelectItem>
                  <SelectItem value="Kodak Ultra Max 400">Kodak Ultra Max 400</SelectItem>
                </SelectContent>
              </Select>
            </div>
