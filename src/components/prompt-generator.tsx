...
export function PromptGenerator() {
  ...
  const generatePrompt = () => {
    ...
    if (formData.composition.view !== "None") prompt += ` | View: ${formData.composition.view}`;
    if (formData.composition.camera !== "None") prompt += ` | Camera: ${formData.composition.camera}`;
    if (formData.composition.lens !== "None") prompt += ` | Lens: ${formData.composition.lens}`;
    if (formData.composition.lighting !== "None") prompt += ` | ${formData.composition.lighting}`;
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label>View</Label>
              <Select
                value={formData.composition.view}
                onValueChange={(value) => handleInputChange("composition.view", value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              <Label>Camera</Label>
              <Select
                value={formData.composition.camera}
                onValueChange={(value) => handleInputChange("composition.camera", value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              <Label>Lens</Label>
              <Select
                value={formData.composition.lens}
                onValueChange={(value) => handleInputChange("composition.lens", value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              ...
              <Select
                value={formData.composition.lighting}
                onValueChange={(value) => handleInputChange("composition.lighting", value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
