...
const PromptGenerator = () => {
  ...
  const generatePrompt = () => {
    const elements = [
      ...
      // Basic composition
      [formData.medium === "None" ? "" : formData.medium, formData.subject]
        .filter(Boolean)
        .join(" of "),
      ...
      formData.filmStyle !== "None" &&
        formData.filmStyle &&
        `${formData.filmStyle} film style`,
      formData.timeEpoch !== "None" &&
        formData.timeEpoch &&
        `Time Period: ${formData.timeEpoch}`,
    ];
              ...
              {type === "custom" && render ? (
                  ...
                  >
                    <SelectTrigger className="h-10">
                      <SelectValue placeholder=" ">
                        {formData[name as keyof typeof formData] === "None"
                          ? ""
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder={
                      name === "subject"
                        ? "E.g., A majestic lion, A futuristic cityscape"
                        : name === "environment"
                        ? "E.g., lush jungle, bustling marketplace"
                        : ""
                    }
                  />
                </div>
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mb-32">
      <Card className="mb-6 w-[98%] mx-auto">
        <CardHeader>
          <CardTitle className="text-4xl font-bold text-slate-600">
      ...
      <form className="space-y-6 w-[98%] mx-auto">
        {renderInputGroup({
          ...
          fields: [
            {
              ...
              options: [
                ...
                {
                  value: "3D Clay Rendered Icon",
                  label: "3D Clay Rendered Icon",
                  group: "2D Mediums",
                },
                ...
                {
                  value: "Crosshatch drawing",
                  label: "Crosshatch drawing",
                  group: "Drawing Techniques",
                },
                {
                  value: "India ink drawing",
                  label: "India ink drawing",
                  group: "Drawing Techniques",
                },
                {
                  value: "Ink drawing",
                ...
                {
                  value: "Marker drawing",
                  label: "Marker drawing",
                  group: "Drawing Techniques",
                },
                {
                ...
                {
                  value: "Pointillism drawing",
                  label: "Pointillism drawing",
                  group: "Drawing Techniques",
                },
                ...
                // Painting Techniques
                {
                  ...
                  group: "Painting Techniques",
                },
                {
                  value: "Airbrush painting",
                  label: "Airbrush painting",
                  group: "Painting Techniques",
                },
                {
                ...
                {
                  value: "Graffiti painting",
                  label: "Graffiti painting",
                  group: "Painting Techniques",
                },
                {
                  value: "Oil painting",
                ...
                {
                  value: "Street art painting",
                  label: "Street art painting",
                  group: "Painting Techniques",
                },

                // Photography
                {
                  value: "35mm film photography",
                  label: "35mm film photography",
                  group: "Photography",
                },
                {
                ...
                {
                  value: "Vintage film photography",
                  label: "Vintage film photography",
                  group: "Photography",
                },
                ...
                {
                  value: "Paper mache sculpture",
                  label: "Paper mache sculpture",
                  group: "3D Techniques",
                },
                ...
                {
                  value: "Holograph display",
                  label: "Holograph display",
                  group: "Displays",
                },
                {
                  value: "LCD display",
                ...
                {
                  value: "Plasma display",
                  label: "Plasma display",
                  group: "Displays",
                },
          ...
          fields: [
            {
              ...
              options: [
                ...
                // Technical Views
                {
                  value: "Cross-sectional view",
                  label: "Cross-sectional view",
                  group: "Technical Views",
                },
                {
                  value: "Exploded view",
                  label: "Exploded view",
            ...
            },
            {
              ...
              options: [
                ...
                // Medium Format
                {
                  value: "Fujifilm GFX 100S",
                  label: "Fujifilm GFX 100S",
                  group: "Medium Format",
                },
                {
                  value: "Hasselblad X2D",
            ...
            },
            {
              ...
              options: [
                ...
                {
                  value: "Twilight lighting",
                  label: "Twilight lighting",
                  group: "Natural Light",
                },
                {
                  value: "Moonlight",
                ...
                // Artificial Light
                {
                  ...
                  label: "Incandescent lighting",
                  group: "Artificial Light",
                },
                {
                ...
                {
                  value: "Wall sconce light",
                  label: "Wall sconce light",
                  group: "Artificial Light",
                },
                {
                  value: "Pendant light",
                ...
                {
                  value: "Vacuum tube bulb",
                  label: "Vacuum tube bulb",
                  group: "Artificial Light",
                },
                {
                  value: "Nixie tube bulb",
                  label: "Nixie tube bulb",
                  group: "Artificial Light",
                },
                {
          ...
          fields: [
            ...
            },
            {
              ...
              options: [
                ...
                {
                  value: "Ancient",
                  label: "Ancient (3000 BCE - 500 CE)",
                  group: "Ancient Times",
                },
                {
                  value: "Classical",
                  label: "Classical (500 BCE - 500 CE)",
                  group: "Ancient Times",
                },
                // Middle Ages
                {
                  value: "Medieval",
                  label: "Medieval (500-1400)",
                  group: "Middle Ages",
                },
                {
                  value: "Renaissance",
                ...
                {
                  value: "Modern",
                  label: "Modern (1901-1945)",
                  group: "Modern Era",
                },
                {
                  value: "Post-Modern",
                  label: "Post-Modern (1945-2000)",
                  group: "Modern Era",
                },
                // Contemporary & Future
                {
          ...
          fields: [
            {
              ...
              options: [
                ...
                // Social Media Ratios
                {
                  ...
                  group: "Social Media Ratios",
                },
                {
                  value: "1.91:1",
                  label: "Facebook/Instagram Landscape (1.91:1)",
                  group: "Social Media Ratios",
                },
              ],
            },
      ...
      <div className="fixed md:w-11/12 w-full lg:max-w-4xl -bottom-1 left-1/2 transform -translate-x-1/2 bg-gray-100 border-gray-300 border-2 pb-8 p-6 rounded-t-lg z-50 shadow-[0_-4px_10px_-2px_rgba(0,0,0,0.2)]">
        <Label className="font-bold uppercase">Final Prompt</Label>
        <div className="bg-white p-4 rounded-lg relative mt-2">
